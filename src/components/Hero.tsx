        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl text-white/80 max-w-2xl fade-in delay-100">
              From <span className="text-neon-gold font-medium">3D worlds</span> to <span className="text-neon-amber font-medium">automation workflows</span>, I turn ideas into reality.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start fade-in delay-200">
              <Link 
                to="/portfolio" 
                className="px-8 py-3 rounded-lg bg-neon-gold text-black font-medium button-glow"
              >
                View My Work
              </Link>
              ...
              <Link 
                to="/contact" 
                className="px-8 py-3 rounded-lg bg-transparent border border-neon-amber text-neon-amber font-medium group hover:bg-neon-amber/10 transition-all duration-300"
              >
                Let's Talk
